...
typedef NS_ENUM(NSInteger, PSAlertControllerStyle) {
    PSAlertControllerStyleAlert = 0,
    PSAlertControllerStyleActionSheet
};
...
@interface PSAlertController : UIViewController
...
@property (nonatomic, assign, readonly) PSAlertControllerStyle preferredStyle;
...
// Transition Animate
@interface PSAlertController (TransitionAnimate)<UIViewControllerTransitioningDelegate>
