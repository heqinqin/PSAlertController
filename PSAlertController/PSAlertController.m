...
@property (nonatomic, assign) PSAlertControllerStyle preferredStyle;
...
- (instancetype)initWithAlertView:(UIView *)alertView preferredStyle:(PSAlertControllerStyle)preferredStyle transitionAnimation:(TYAlertTransitionAnimation)transitionAnimation transitionAnimationClass:(Class)transitionAnimationClass
{
...
+ (instancetype)alertControllerWithAlertView:(UIView *)alertView
{
    return [[self alloc]initWithAlertView:alertView
                           preferredStyle:PSAlertControllerStyleAlert
                      transitionAnimation:TYAlertTransitionAnimationFade
                 transitionAnimationClass:nil];
}

+ (instancetype)alertControllerWithAlertView:(UIView *)alertView preferredStyle:(PSAlertControllerStyle)preferredStyle
{
    return [[self alloc]initWithAlertView:alertView
...
+ (instancetype)alertControllerWithAlertView:(UIView *)alertView preferredStyle:(PSAlertControllerStyle)preferredStyle transitionAnimation:(TYAlertTransitionAnimation)transitionAnimation
{
    return [[self alloc]initWithAlertView:alertView
                           preferredStyle:preferredStyle
...
+ (instancetype)alertControllerWithAlertView:(UIView *)alertView preferredStyle:(PSAlertControllerStyle)preferredStyle transitionAnimationClass:(Class)transitionAnimationClass
{
    return [[self alloc]initWithAlertView:alertView
                           preferredStyle:preferredStyle
...
- (void)viewDidLoad {
    ...
    if (_preferredStyle == PSAlertControllerStyleAlert) {
