...
#define kContentViewSpace 30

#define kTextLabelSpace  10
...
- (void)configureProperty
{
    ...
    _buttonContentViewEdge =  0;//kContentViewEdge;
    _buttonContentViewTop = kContentViewSpace;
    _buttonCornerRadius = 0;
    _buttonFont = [UIFont fontWithName:@"HelveticaNeue" size:18];
    _buttonDefaultBgColor =  [UIColor colorWithRed:34/255.0 green:34/255.0 blue:34/255.0 alpha:1];
    _buttonCancelBgColor =    [UIColor colorWithRed:34/255.0 green:34/255.0 blue:34/255.0 alpha:1];
    _buttonDestructiveBgColor = [UIColor colorWithRed:255/255.0 green:139/255.0 blue:61/255.0 alpha:1];
    ...
    _messageTextColor =  [UIColor colorWithRed:139/255.0 green:139/255.0 blue:139/255.0 alpha:1];
    _titleTextColor =  [UIColor colorWithRed:34/255.0 green:34/255.0 blue:34/255.0 alpha:1];
...
- (void)addAction:(TYAlertAction *)action
{
    ...
    button.layer.borderColor =  [UIColor colorWithRed:239/255.0 green:239/255.0 blue:239/255.0 alpha:1.0].CGColor;
